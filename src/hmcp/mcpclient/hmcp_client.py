...
from hmcp.auth import OAuthClient, AuthConfig, jwt_handler
...
class HMCPClient:
    ...
    async def create_message(
        ...
        """
        # Log the number of messages being sent in the sampling request
        ...
        return await self.session.send_request(types.ClientRequest(createMessageRequest), types.CreateMessageResult)